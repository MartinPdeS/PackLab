...
Computation times
=================
**00:19.091** total execution time for 8 files **from all galleries**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_gallery_validation_monte_carlo_estimator_vs_analytical.py` (``../examples/validation/monte_carlo_estimator_vs_analytical.py``)
     - 00:11.549
     - 0.0
   ...
   * - :ref:`sphx_glr_gallery_monte_carlo_monte_carlo_poly_disperse.py` (``../examples/monte_carlo/monte_carlo_poly_disperse.py``)
     - 00:00.151
     - 0.0
   * - :ref:`sphx_glr_gallery_validation_monte_carlo_vs_analytical.py` (``../examples/validation/monte_carlo_vs_analytical.py``)
     - 00:00.106
     - 0.0
